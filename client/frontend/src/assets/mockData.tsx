...
export const MOCK_MESSAGES: Record<string, Message[]> = {
  room1: [
    {
      ...
      roomId: "room1",
      senderId: "u2",
      content: "Hey! Have you checked the new Kafka topic configs?",
      timestamp: ago(60),
      status: "read",
    },
    {
      ...
      senderId: "me",
      content:
        "Yeah, I saw them this morning. The partition count looks good for our load.",
      timestamp: ago(58),
      status: "read",
    },
    {
      ...
      senderId: "u2",
      content:
        "Great. I was worried about throughput on the auth events topic.",
      timestamp: ago(55),
      status: "read",
    },
    {
      ...
      senderId: "me",
      content:
        "Should be fine. We're running 3 consumers per partition anyway. Let me know if you see lag.",
      timestamp: ago(52),
      status: "read",
    },
    {
      ...
      senderId: "u2",
      content:
        "Will do! Also, the WebSocket reconnect logic needs a review—can you take a look?",
      timestamp: ago(30),
      status: "read",
    },
    {
      ...
      roomId: "room1",
      senderId: "me",
      content: "Sure, I'll open a PR comment by EOD.",
      timestamp: ago(28),
      status: "read",
    },
    {
  ...
  room2: [
    ...
    },
    {
      ...
      roomId: "room2",
      senderId: "u3",
      content: "Cool, I'll start the Zoom link.",
      timestamp: ago(17),
      status: "delivered",
    },
  ],
  room3: [
    {
      ...
      roomId: "room3",
      senderId: "u4",
      content: "Can you share the PostgreSQL schema for the messages table?",
      timestamp: ago(120),
      status: "read",
    },
    {
      ...
      roomId: "room3",
      senderId: "me",
      content: "Sure! It's in /db/migrations/003_messages.sql",
      timestamp: ago(115),
      status: "read",
    },
    {
  ...
  room5: [
    {
      ...
      roomId: "room5",
      senderId: "u5",
      content: "Deployment is live on staging 🚀",
      timestamp: ago(45),
      status: "read",
    },
    {
      ...
      roomId: "room5",
      senderId: "me",
      content: "Awesome! Running smoke tests now.",
      timestamp: ago(40),
      status: "read",
    },
    {
      ...
      roomId: "room5",
      senderId: "u5",
      content: "Let me know if anything fails. I'm on standby.",
      timestamp: ago(38),
      status: "delivered",
    },
  ],
